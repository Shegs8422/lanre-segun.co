...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      }, _attrs))} data-v-28b7d43a><main class="flex flex-col max-w-3xl mx-auto items-center pt-16 pb-12 px-8 gap-12" data-v-28b7d43a><header class="w-full flex justify-between items-center pb-4 flex-shrink-0 scroll-snap-align-start" style="${ssrRenderStyle({ "scroll-snap-align": "start" })}" data-v-28b7d43a><h2 class="text-3xl font-medium tracking-tight" data-v-28b7d43a>Projects</h2></header><!--[-->`);
      ssrRenderList(unref(projects), (project, index2) => {
        _push(`<div class="${ssrRenderClass([activeProject.value === index2 ? "opacity-100 scale-100" : "opacity-40 scale-90 grayscale-[0.5]", "project-item flex flex-col gap-6 w-full flex-shrink-0 transition-all duration-700 ease-in-out"])}" style="${ssrRenderStyle({ "scroll-snap-align": "center", "min-height": "80vh", "justify-content": "center" })}" data-v-28b7d43a>`);
        _push(ssrRenderComponent(_component_NuxtLink, {
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`<img${ssrRenderAttr("src", project.coverImage)}${ssrRenderAttr("alt", project.title)} class="w-full h-full object-cover transition-transform duration-700 group-hover:scale-110" data-v-28b7d43a${_scopeId}><div class="absolute inset-0 bg-black/20 group-hover:bg-transparent transition-colors duration-500" data-v-28b7d43a${_scopeId}></div>`);
            } else {
              return [
                createVNode("img", {
        ...
        _push(`<div class="flex flex-col gap-3 px-2" data-v-28b7d43a><div class="flex justify-between items-center" data-v-28b7d43a><span class="text-sm font-mono text-blue-500 font-bold uppercase tracking-widest" data-v-28b7d43a>${ssrInterpolate(project.year || "2024")}</span>`);
        if (project.featured) {
          _push(`<div class="px-2 py-0.5 bg-yellow-500/10 text-yellow-500 text-[10px] font-bold rounded border border-yellow-500/20 uppercase tracking-tighter" data-v-28b7d43a> Featured</div>`);
        } else {
          _push(`<!---->`);
        }
        _push(`</div><h3 class="text-3xl font-bold tracking-tight" data-v-28b7d43a>${ssrInterpolate(project.title)}</h3><p class="text-muted-foreground text-lg max-w-xl leading-relaxed" data-v-28b7d43a>${ssrInterpolate(project.description)}</p><div class="flex flex-wrap gap-2 mt-1" data-v-28b7d43a><!--[-->`);
        ssrRenderList(project.tags, (tag) => {
          _push(`<span class="text-[10px] text-neutral-500 uppercase tracking-widest border border-neutral-800 px-2 py-0.5 rounded" data-v-28b7d43a>${ssrInterpolate(tag)}</span>`);
        });
        _push(`<!--]--></div>`);
        _push(ssrRenderComponent(_component_NuxtLink, {
          to: `/projects/${project.slug}`,
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(` View Case Study <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" data-v-28b7d43a${_scopeId}><path d="M5 12h14" data-v-28b7d43a${_scopeId}></path><path d="m12 5 7 7-7 7" data-v-28b7d43a${_scopeId}></path></svg>`);
            } else {
              return [
      ...
      _push(`<!--]--><footer class="h-[20vh] flex-shrink-0" data-v-28b7d43a></footer></main></div>`);
    };
  }
});
...
const index = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-28b7d43a"]]);

export { index as default };
//# sourceMappingURL=index-COMyfeTT.mjs.map
