    ...
    <Transition name="fade">
        <div v-if="isOpen" class="fixed inset-0 z-100 flex items-center justify-center bg-black/80 backdrop-blur-sm">
            <div
                ...
                <form class="flex flex-col gap-6" @submit.prevent="handleSetup">
                    <!-- Question 1 -->
                    <div class="flex flex-col gap-2">
                        <label class="text-xs font-bold uppercase text-neutral-500">{{ questionOptions[0] }}</label>
                        <input
v-model="answers[0]" type="text" placeholder="Your answer" required autocomplete="off"
                    ...
                    <div class="flex flex-col gap-2">
                        ...
                        <input
v-model="answers[1]" type="text" placeholder="Your answer" required autocomplete="off"
                            class="bg-black/50 border border-neutral-700 rounded-lg px-4 py-2.5 text-white focus:outline-none focus:border-blue-500 transition-colors" >
                    </div>
                    ...
                    <div class="flex flex-col gap-2">
                        ...
                        <input
v-model="answers[2]" type="text" placeholder="Your answer" required autocomplete="off"
                            class="bg-black/50 border border-neutral-700 rounded-lg px-4 py-2.5 text-white focus:outline-none focus:border-blue-500 transition-colors" >
                    </div>
