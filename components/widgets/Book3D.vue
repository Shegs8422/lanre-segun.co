  ...
  <div class="absolute select-none pointer-events-auto" :class="classes"
    ...
    <div class="group relative transition-all duration-500 ease-out hover:-translate-y-6 hover:shadow-2xl"
      ...
      <div
        ...
        :style="{ backgroundColor: color, height: height + 'px', left: '0px' }"></div>
      ...
      <div
        ...
        <!-- Spine Highlight -->
        <div
          class="absolute left-0 top-0 bottom-0 w-[5px] bg-gradient-to-r from-white/40 to-transparent pointer-events-none">
        </div>
      </div>

      <!-- Inside Page (Visible when cover opens) -->
      <div
        class="absolute inset-0 bg-[#fff] rounded-r-sm shadow-inner z-10 flex items-center justify-center overflow-hidden">
        <!-- Fake text lines -->
      ...
      <div
        ...
        style="background: repeating-linear-gradient(90deg, #fff, #fff 1px, #f0f0f0 1px, #f0f0f0 2px);"></div>
