<template>
    <button type="button"
        class="group relative inline-flex items-center justify-center gap-2 overflow-hidden rounded-full p-[3px] transition-all duration-300 hover:scale-105 active:scale-95">
        <!-- Gemini Blue Glow Border (animated glow on hover) -->
        <span
            class="absolute inset-[-1000%] animate-[spin_3s_linear_infinite] bg-[conic-gradient(from_90deg_at_50%_50%,#4285F4_0%,#4796E3_25%,#8BB8F8_50%,#C4DCFB_75%,#E3F2FD_100%)] opacity-0 blur-[3px] transition-all duration-500 group-hover:opacity-80" />

        <!-- Button Content -->
        <span
            class="relative inline-flex h-full w-full items-center justify-center rounded-full bg-white dark:bg-zinc-950 px-3 py-1.5 text-sm font-medium text-zinc-800 dark:text-zinc-200 backdrop-blur-3xl transition-all group-hover:bg-white/90 dark:group-hover:bg-zinc-900/90">
            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-auto" viewBox="0 0 288 65" fill="none">
                <path
                ...
                <g mask="url(#mask0_10859_4895)">
                    <g filter="url(#filter0_f_10859_4895)">
                        <ellipse cx="14.4072" cy="16.9504" rx="14.4072" ry="16.9504"
                            transform="matrix(0.942341 0.334654 -0.334652 0.942342 -8.09058 13.9664)" fill="#FFE432" />
                    </g>
                    ...
                    <g filter="url(#filter2_f_10859_4895)">
                        <ellipse cx="18.9512" cy="57.3856" rx="19.4934" ry="25.2529"
                            transform="rotate(-2.79865 18.9512 57.3856)" fill="#00B95C" />
                    </g>
                    ...
                    <g filter="url(#filter4_f_10859_4895)">
                        <ellipse cx="20.0204" cy="56.2114" rx="19.1065" ry="21.0345"
                            transform="rotate(-31.3178 20.0204 56.2114)" fill="#00B95C" />
                    </g>
                    ...
                    <g filter="url(#filter6_f_10859_4895)">
                        <ellipse cx="21.222" cy="22.3842" rx="21.222" ry="22.3842"
                            transform="matrix(0.795985 0.605316 -0.605314 0.795987 -2.85815 -7.53723)" fill="#FBBC04" />
                    </g>
                    <g filter="url(#filter7_f_10859_4895)">
                        <ellipse cx="24.4687" cy="22.6039" rx="24.4687" ry="22.6039"
                            transform="matrix(0.824033 0.566542 -0.566539 0.824035 40.1882 0.315002)" fill="#3186FF" />
                    </g>
                    ...
                    <g filter="url(#filter9_f_10859_4895)">
                        <ellipse cx="19.9023" cy="3.35597" rx="27.9712" ry="17.3877"
                            transform="rotate(-42.848 19.9023 3.35597)" fill="#FC413D" />
                    </g>
                    <g filter="url(#filter10_f_10859_4895)">
                        <ellipse cx="13.5831" cy="46.7501" rx="14.9887" ry="8.71667"
                            transform="rotate(35.592 13.5831 46.7501)" fill="#FFEE48" />
                    </g>
                </g>
                <defs>
                    <filter id="filter0_f_10859_4895" x="-19.8236" y="13.1523" width="39.2739" height="43.2171"
                        filterUnits="userSpaceOnUse" color-interpolation-filters="sRGB">
                        <feFlood flood-opacity="0" result="BackgroundImageFix" />
                        <feBlend mode="normal" in="SourceGraphic" in2="BackgroundImageFix" result="shape" />
                        <feGaussianBlur stdDeviation="2.45965" result="effect1_foregroundBlur_10859_4895" />
                    </filter>
                    <filter id="filter1_f_10859_4895" x="-15.001" y="-40.257" width="84.8677" height="85.6878"
                        filterUnits="userSpaceOnUse" color-interpolation-filters="sRGB">
                        <feFlood flood-opacity="0" result="BackgroundImageFix" />
                        <feBlend mode="normal" in="SourceGraphic" in2="BackgroundImageFix" result="shape" />
                        <feGaussianBlur stdDeviation="11.8911" result="effect1_foregroundBlur_10859_4895" />
                    </filter>
                    <filter id="filter2_f_10859_4895" x="-20.7758" y="11.9273" width="79.454" height="90.9166"
                        filterUnits="userSpaceOnUse" color-interpolation-filters="sRGB">
                        <feFlood flood-opacity="0" result="BackgroundImageFix" />
                        <feBlend mode="normal" in="SourceGraphic" in2="BackgroundImageFix" result="shape" />
                        <feGaussianBlur stdDeviation="10.1086" result="effect1_foregroundBlur_10859_4895" />
                    </filter>
                    <filter id="filter3_f_10859_4895" x="-20.7758" y="11.9273" width="79.454" height="90.9166"
                        filterUnits="userSpaceOnUse" color-interpolation-filters="sRGB">
                        <feFlood flood-opacity="0" result="BackgroundImageFix" />
                        <feBlend mode="normal" in="SourceGraphic" in2="BackgroundImageFix" result="shape" />
                        <feGaussianBlur stdDeviation="10.1086" result="effect1_foregroundBlur_10859_4895" />
                    </filter>
                    <filter id="filter4_f_10859_4895" x="-19.8449" y="15.459" width="79.7306" height="81.5048"
                        filterUnits="userSpaceOnUse" color-interpolation-filters="sRGB">
                        <feFlood flood-opacity="0" result="BackgroundImageFix" />
                        <feBlend mode="normal" in="SourceGraphic" in2="BackgroundImageFix" result="shape" />
                        <feGaussianBlur stdDeviation="10.1086" result="effect1_foregroundBlur_10859_4895" />
                    </filter>
                    <filter id="filter5_f_10859_4895" x="29.8324" y="-11.5524" width="75.1172" height="73.7582"
                        filterUnits="userSpaceOnUse" color-interpolation-filters="sRGB">
                        <feFlood flood-opacity="0" result="BackgroundImageFix" />
                        <feBlend mode="normal" in="SourceGraphic" in2="BackgroundImageFix" result="shape" />
                        <feGaussianBlur stdDeviation="9.60613" result="effect1_foregroundBlur_10859_4895" />
                    </filter>
                    <filter id="filter6_f_10859_4895" x="-38.5827" y="-16.2526" width="78.1352" height="78.7578"
                        filterUnits="userSpaceOnUse" color-interpolation-filters="sRGB">
                        <feFlood flood-opacity="0" result="BackgroundImageFix" />
                        <feBlend mode="normal" in="SourceGraphic" in2="BackgroundImageFix" result="shape" />
                        <feGaussianBlur stdDeviation="8.70591" result="effect1_foregroundBlur_10859_4895" />
                    </filter>
                    <filter id="filter7_f_10859_4895" x="8.1068" y="-5.96578" width="78.877" height="77.5394"
                        filterUnits="userSpaceOnUse" color-interpolation-filters="sRGB">
                        <feFlood flood-opacity="0" result="BackgroundImageFit" />
                        <feBlend mode="normal" in="SourceGraphic" in2="BackgroundImageFix" result="shape" />
                        <feGaussianBlur stdDeviation="7.77473" result="effect1_foregroundBlur_10859_4895" />
                    </filter>
                    <filter id="filter8_f_10859_4895" x="13.5873" y="-18.4881" width="56.2718" height="51.8102"
                        filterUnits="userSpaceOnUse" color-interpolation-filters="sRGB">
                        <feFlood flood-opacity="0" result="BackgroundImageFix" />
                        <feBlend mode="normal" in="SourceGraphic" in2="BackgroundImageFix" result="shape" />
                        <feGaussianBlur stdDeviation="6.95694" result="effect1_foregroundBlur_10859_4895" />
                    </filter>
                    <filter id="filter9_f_10859_4895" x="-15.5259" y="-31.297" width="70.8565" height="69.3059"
                        filterUnits="userSpaceOnUse" color-interpolation-filters="sRGB">
                        <feFlood flood-opacity="0" result="BackgroundImageFix" />
                        <feBlend mode="normal" in="SourceGraphic" in2="BackgroundImageFix" result="shape" />
                        <feGaussianBlur stdDeviation="5.87598" result="effect1_foregroundBlur_10859_4895" />
                    </filter>
                    <filter id="filter10_f_10859_4895" x="-14.1676" y="20.9644" width="55.5015" height="51.5714"
                        filterUnits="userSpaceOnUse" color-interpolation-filters="sRGB">
                        <feFlood flood-opacity="0" result="BackgroundImageFix" />
                        <feBlend mode="normal" in="SourceGraphic" in2="BackgroundImageFix" result="shape" />
                        <feGaussianBlur stdDeviation="7.27253" result="effect1_foregroundBlur_10859_4895" />
                    </filter>
                    <linearGradient id="paint0_linear_10859_4895" x1="18.4474" y1="43.4202" x2="52.1528" y2="15.0035"
