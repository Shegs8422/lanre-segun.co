    ...
    <ClientOnly>
        ...
        <DraggableCanvas v-else :class="{ 'opacity-0': isPreloading }">
            ...
            <div
                ...
                <div class="select-none flex flex-col gap-2 relative rounded-lg w-[568px] col-start-4 row-start-4 col-span-2 row-span-2 shadow-lg h-fit entrance-stagger"
                    style="--stagger: 1">
                    <ProfileCard />
                </div>

                <!-- Education Card - col 4, row 7 -->
                <div class="select-none flex flex-col gap-2 relative rounded-lg w-[568px] col-start-4 row-start-7 col-span-2 row-span-1 shadow-lg h-fit bottom-[340px] entrance-stagger"
                    style="--stagger: 39">
                    <EducationCard />
                </div>
                ...
                <Book3D cover="/images/The Subtle Art of Not Giving a Fuck - Mark Manson.jpg"
                    ...
                    :height="198" classes="col-start-2 row-start-4 rotate-[6deg] entrance-stagger" style="--stagger: 22"
                    :stagger="22" />
                ...
                <svg style="--stagger:40"
                    ...
                    <rect fill="#3178c6" height="512" width="512"></rect>
                    <path
