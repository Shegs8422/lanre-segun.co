    ...
    <ClientOnly>
        ...
        <DraggableCanvas v-else :class="{ 'opacity-0': isPreloading }">
            ...
            <div
                ...
                <!-- Background fill -->
                <div class="z-negative w-[2992px] h-[2240px] pointer-events-none" />

                <!-- Profile Card - col 4, row 4 -->
                <div class="select-none flex flex-col gap-2 relative rounded-lg w-profile-card col-start-4 row-start-4 col-span-2 row-span-2 shadow-lg h-fit entrance-stagger"
                    style="--stagger: 1">
                    <ProfileCard />
                </div>

                <!-- Education Card - col 4, row 7 -->
                <div class="select-none flex flex-col gap-2 relative rounded-lg w-profile-card col-start-4 row-start-7 col-span-2 row-span-1 shadow-lg h-fit bottom-[340px] entrance-stagger"
                    style="--stagger: 39">
                    <EducationCard />
                </div>

                <!-- Drawing Canvas - col 2, row 2 -->
                <div class="select-none relative col-start-2 row-start-2 w-[340px] h-[340px] left-[60px] top-[140px] rotate-[-4deg] entrance-stagger"
                    style="--stagger: 9" data-no-drag="true">
                    <DrawingCanvas />
                </div>

                <!-- Flip Clock - col 7, row 5 -->
                <div class="col-start-7 col-span-2 row-start-5 rotate-[4deg] relative z-50 w-fit top-[40px] left-[60px] entrance-stagger"
                    style="--stagger: 12">
                    <FlipClock />
                </div>
                ...
                <Book3D cover="/images/The Effective Product Designer - ARTIOM DASHINSKY.jpg"
                    title="The Effective Product Designer" author="ARTIOM DASHINSKY" color="var(--color-book-orange)"
                    :width="133" :height="201"
                ...
                <Book3D cover="/images/The Subtle Art of Not Giving a Fuck - Mark Manson.jpg"
                    title="The Subtle Art of Not Giving a Fuck" author="Mark Manson" color="var(--color-book-orange)"
                    :width="135" :height="198" classes="col-start-2 row-start-4 rotate-[6deg] entrance-stagger"
                    style="--stagger: 22" :stagger="22" />

                <Book3D cover="/images/Designing Brand Identity - Alina Wheeler.jpg" title="Designing Brand Identity"
                    author="Alina Wheeler" color="var(--color-book-red)" :width="135" :height="200"
                ...
                <VinylRecord :key="`kendrick-heart`" cover="/images/The Heart 5 - Kendrick Lamar.jpg"
                    ...
                    music-file="/audio/the-heart-part-5.mp3"
                ...
                <div style="--stagger:42"
                    ...
                    <div class="relative w-full h-full bg-white flex items-center justify-center p-8">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 96 96" class="w-full h-auto">
                            ...
                            <path fill="#20b15a" d="M75.9062 33.4158h3.3047v22.4443h-3.3047V33.4158Z" />
                            <path fill="#3686f7"
                ...
                <svg style="--stagger:40"
                    class="select-none border-white border-4 rounded-lg relative row-start-2 col-start-1 top-[140px] left-[40px] entrance-stagger"
                ...
                <svg style="--stagger:15"
                    class="select-none relative left-[140px] col-start-7 row-start-7 top-[40px] border-4 border-white rounded-lg entrance-stagger"
                    width="127" height="57" viewBox="0 0 138 57" aria-label="MDX" role="img">
                    <rect height="55.5" rx="4.5" width="136.5" x=".75" y=".75" />
                ...
                <DraggableWidget
                    ...
                    style="--stagger: 3">
                    <div
                        class="rotate-14 transition-transform hover:scale-105 duration-300 border border-black/10 dark:border-white/10 shadow-xl bg-white dark:bg-tooltip-bg p-3 pb-8">
                ...
                <DraggableWidget
                    ...
                    style="--stagger: 4">
                    <div
                        class="-rotate-12 transition-transform hover:scale-105 duration-300 border border-black/10 dark:border-white/10 shadow-xl bg-white dark:bg-tooltip-bg p-3 pb-8">
                ...
                <DraggableWidget
                    ...
                    style="--stagger: 5">
                    <div
                        class="rotate-2 transition-transform hover:scale-105 duration-300 border border-black/10 dark:border-white/10 shadow-xl bg-white dark:bg-tooltip-bg p-3 pb-8">
                ...
                <DraggableWidget
                    ...
                    style="--stagger: 6">
                    <div
                        class="rotate-[8deg] transition-transform hover:scale-105 duration-300 border border-black/10 dark:border-white/10 shadow-xl bg-white dark:bg-tooltip-bg p-3 pb-8">
...
const bodyClass = computed(() => isMobile.value ? 'bg-background' : 'overflow-hidden bg-background')
